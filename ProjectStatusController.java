...
import com.nsu.service.ProjectStatusService;
...
public class ProjectStatusController {
    ...
    @GetMapping
    public PagedEntitiesResponse<ProjectStatus> findAllPaged(@RequestParam(name ="page") Optional<Integer> page,
...
//    }
    ...
    public List<String> getHeaders() {
        Field[] fields = ProjectStatus.class.getDeclaredFields();
