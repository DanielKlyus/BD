...
import com.nsu.service.TypeEquipmentService;
...
public class TypeEquipmentController {
    ...
    @GetMapping
    public PagedEntitiesResponse<TypeEquipment> findAllPaged(@RequestParam(name ="page") Optional<Integer> page,
...
//    }
    ...
    @GetMapping("/{id}")
    public TypeEquipment findById(@PathVariable("id") Integer id){
        return service.getById(id);
    }

    @GetMapping("/headers")
    public List<String> getHeaders() {
        Field[] fields = TypeEquipment.class.getDeclaredFields();
